...
unit_name="dlm-wonn-phase5-l12k768-90k"
memory_high="${DLM_WONN_MEMORY_HIGH:-14G}"
memory_max="${DLM_WONN_MEMORY_MAX:-18G}"
pipeline="$repo_root/scripts/run_wonn_l12k768_90k_pipeline.sh"
...
command=(
    systemd-run --user
    "--unit=$unit_name"
    "--description=DLM-WONN WMT14 L12 K768 T3 from scratch to 90K"
