...
run_dir="${DLM_WONN_L12K768_RUN_DIR:-$main_checkout/outputs/phase5/wonn_l12k768t3_seed42_b12_0_90k}"
elf_run_dir="${DLM_WONN_ELF_BASELINE:-$main_checkout/.worktrees/phase5-wmt14/outputs/phase5/elf_b_seed42_b12_0_90k}"
